...
READ_RE='kb_api(_status)?[[:space:]]+GET|api "\$API/tasks/|kb_card_witness|_kbc_link_witness|kb_confirm_card|_kbc_fetch_fields|_kbc_field_populated|fetch_board_cards|by_ref_state'
