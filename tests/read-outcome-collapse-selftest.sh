...
#   * The bash embedded in this repo's composite actions — every `action.yml` in the tree, not
#     a list written here (one stood here naming two of what are now three).
